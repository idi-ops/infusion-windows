...
Vagrant.configure(2) do |config|
  ...
  config.vm.provision "shell", path: "chocolatey.bat"

  config.vm.provision "shell", path: "chocolatey-packages.bat"

  config.vm.provision "shell", path: "npm-packages.bat"

  config.vm.provision "shell", path: "firewall.bat"
